...
Balance = create_action("Balance", [("time", "time"), ("subject", "sid"), ("balance", "balance")], type_dict,
                        abstraction=False)
...
Assign_Expertise = create_action("Assign_expertise", [("time", "time"), ("expertise", "expertise"), ("a1", "aid")],
                                 type_dict)

Request_Erase, Erase = create_pair_action("Erase", [("subject", "sid"), ("pid", "pid"), ("time", "time")], type_dict)
Request_Patient_Access, Patient_Access = create_pair_action("Patient_Access",
                                                            [("subject", "sid"), ("pid", "pid"), ("pvalue", "pvalue"),
                                                             ("time", "time")], type_dict)

Request_Action = [Request_Access, Request_Consent, Request_Disclose, Request_Use, Request_Erase, Request_Patient_Access,
                  Request_Update]
ACTION = Request_Action + [Patient_Access, Collect, Update, Has_Expertise, Access, Disclose, Consent, Authorize, Revoke,
                           Assign_Expertise, Patient_Consent, Use, Erase, TimeStamp, Balance]
ACTION_MAP = {}
for act in ACTION:
    ACTION_MAP[act.action_name.upper()] = act

# additional correction if needed
ACTION_MAP.update({"Collect".upper(): Collect, "Update".upper(): Update, "Has_Expertise".upper(): Has_Expertise,
                   "Access".upper(): Access, "Disclose".upper(): Disclose,
                   "Consent".upper(): Consent, "Authorize".upper(): Authorize, "Revoke".upper(): Revoke,
                   "Assign_Expertise".upper(): Assign_Expertise,
